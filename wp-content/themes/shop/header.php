...
<head>
    ...
    <link rel="apple-touch-icon" href="<?= bloginfo('template_directory') ?>/assets/img/apple-icon.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?= bloginfo('template_directory') ?>/assets/img/favicon.ico">
