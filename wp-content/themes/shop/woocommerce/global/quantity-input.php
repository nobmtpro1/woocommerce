...
<div class="col-auto">
	<ul class="list-inline pb-3">
		<li class="list-inline-item text-right">
			Quantity
			<input type="hidden" name="product-quanity" class="my-product-quanity" id="product-quanity" value="1">
		</li>
	...
	<div class="quantity woo-quantity">
		<?php
		/**
